...
#ifndef _FAST_DDS_GENERATED_VELOCITYMSG_H_
#define _FAST_DDS_GENERATED_VELOCITYMSG_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(VelocityMsg_SOURCE)
#define VelocityMsg_DllAPI __declspec( dllexport )
#else
#define VelocityMsg_DllAPI __declspec( dllimport )
#endif // VelocityMsg_SOURCE
#else
#define VelocityMsg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define VelocityMsg_DllAPI
#endif // _WIN32
